...
if($_SESSION['logged_id']==$order['f_customer_id']){
...
<head>
	...
	<title>ORDER SUMMARY - <?php echo $_GET['order_no']; ?></title>
...
<div class="container">
    ...
    <div class="row">
        	...
        	<br>
    	<h4 align="center" class="title-separator">Summary of your order</h4>
        ...
        while($order_detail = mysqli_fetch_assoc($order_details)){
            ...
            while($order_list = mysqli_fetch_assoc($order_lists)){
                echo '<tr>
                        ...
                        <td style="width:55%;">'.$order_list["f_value"].'</td>';
                        if($order_list["f_label"]=='Model'){
                            echo '<td class="ptoright" style="width:20%;">'.$order_list["f_amount"].' USD</td>';
                        }else{
