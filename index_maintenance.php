	        	...
	        	<label class="switch">
						...
						<div class="row">
							<div class="col-lg-12 col-xs-12 btn-white">
								<button class="btn btn-outline-light btn-sm btn-block lightbutton" id = 'chkduplicatebtn'>Check for duplicates</button>
							</div>
						</div>

						<br>
						<p class="stronggg" style="margin-bottom: 0px;">Back-up <i class="fa fa-folder-open fakehref" id='folderbtn'></i></p>
						<div class="row">
							<div class="col-lg-12 btn-white">
								<button class="btn btn-outline-light btn-sm btn-block lightbutton" id="backup_file_btn" onclick="showSnackbar(`Not available`,`black`);//backup('files');" disabled>System Files</button>
							</div>
							<div class="col-lg-12 btn-white">
